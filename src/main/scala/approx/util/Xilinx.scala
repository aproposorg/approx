...
object Xilinx {
  ...
  object Common {
    ...
    class LUT1(init: String = "2'b00") extends ExtModule(Map("INIT" -> RawParam(init))) {
    ...
    class LUT2(init: String = "4'h0") extends ExtModule(Map("INIT" -> RawParam(init))) {
      val io = IO(new Bundle {
        val O  = Output(Bool())
        val I0 = Input(Bool())
        val I1 = Input(Bool())
    ...
    class LUT3(init: String = "8'h00") extends ExtModule(Map("INIT" -> RawParam(init))) {
      val io = IO(new Bundle {
        val O  = Output(Bool())
        val I0 = Input(Bool())
        val I1 = Input(Bool())
    ...
    class LUT4(init: String = "16'h0000") extends ExtModule(Map("INIT" -> RawParam(init))) {
      val io = IO(new Bundle {
        val O  = Output(Bool())
        val I0 = Input(Bool())
        val I1 = Input(Bool())
    ...
    class LUT5(init: String = "32'h00000000") extends ExtModule(Map("INIT" -> RawParam(init))) {
      val io = IO(new Bundle {
        val O  = Output(Bool())
        val I0 = Input(Bool())
        val I1 = Input(Bool())
    ...
    class LUT6(init: String = "64'h0000000000000000") extends ExtModule(Map("INIT" -> RawParam(init))) {
      val io = IO(new Bundle {
        val O  = Output(Bool())
        val I0 = Input(Bool())
        val I1 = Input(Bool())
    ...
    class LUT6_2(init: String = "64'h0000000000000000") extends ExtModule(Map("INIT" -> RawParam(init))) {
      val io = IO(new Bundle {
        val O6 = Output(Bool())
        val O5 = Output(Bool())
        val I0 = Input(Bool())
   ...
   */
  object SevenSeries {
    class CARRY4 extends ExtModule {
      val io = IO(new Bundle {
   ...
   */
  object UltraScale {
    class CARRY8(carryType: String = "SINGLE_CY8") extends ExtModule(Map("CARRY_TYPE" -> StringParam(carryType))) {
      val io = IO(new Bundle {
        val CI     = Input(Bool())
  ...
  object Versal {
    ...
    class LUT6CY(init: String) extends ExtModule(Map("INIT" -> RawParam(init))) {
      val io = IO(new Bundle {
        val I0   = Input(Bool())
        val I1   = Input(Bool())
        val I2   = Input(Bool())
    ...
    class LOOKAHEAD8(lookB: String, lookD: String, lookF: String, lookH: String)
      extends ExtModule(Map("LOOKB" -> StringParam(lookB), "LOOKD" -> StringParam(lookD),
